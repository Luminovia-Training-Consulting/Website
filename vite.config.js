...
const prerenderRoutes = [
    ...
    ["/skills", "Skills & Consulting Topics | AI, IT, Cybersecurity and Business Technology", "A practical skill map for AI literacy, agentic workflows, Python, SQL, cybersecurity, IT consulting, AI consulting, business computer science and digital education."],
    ...
    ["/my-way", "My Way | Professional Timeline and Teaching Background", "Professional timeline from business computer science, software practice and entrepreneurship to AI, IT and cybersecurity training from Brisbane."],
