...
const prerenderRoutes = [
    ...
    ["/skills", "Skills & Consulting Topics | AI, IT, Cybersecurity and Business Technology", "A practical skill map for AI literacy, agentic workflows, Python, SQL, cybersecurity, IT consulting, AI consulting, business informatics and digital education."],
    ...
    ["/portfolio", "Consulting Portfolio | IT, AI and Business Consulting", "Portfolio and proof for IT consulting, AI consulting, business consulting, digital education, technical project practice and professional training delivery."],
    ["/pricing", "Pricing | AI, IT and Business Training Rates", "Transparent orientation rates for education-sector teaching, corporate training, talks and workshops, plus consulting and project implementation pricing on request."],
