...
const dictionaries = {
  en: {
    ...
    bookTrainingCall: "Book training call",
    linkedin: "LinkedIn",
    menu: "Menu",
    close: "Close",
    open: "Open",
    ...
    contact: {
      badge: "Book training",
      title: "Book me for lectures, workshops, training or talks.",
      copy: "Send topic, audience, learner level, timeframe and desired outcome. I will suggest a suitable format: keynote, workshop, multi-day training, course delivery or curriculum support.",
  ...
  de: {
    ...
    bookTraining: "Training buchen",
    bookTrainingCall: "Trainingstermin buchen",
    linkedin: "LinkedIn",
    menu: "Menü",
    close: "Schließen",
    open: "Öffnen",
    ...
    contact: {
      badge: "Training buchen",
      title: "Buchen Sie mich für Vorlesungen, Workshops, Trainings oder Talks.",
      copy: "Senden Sie Thema, Zielgruppe, Wissensstand, Zeitraum und gewünschtes Ergebnis. Ich schlage ein passendes Format vor: Keynote, Workshop, mehrtägiges Training, Kursdurchführung oder Curriculum-Support.",
