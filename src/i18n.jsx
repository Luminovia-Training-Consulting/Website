...
const dictionaries = {
    en: {
        ...
        home: {
            ...
            salesSignalCopy: "The page should make it easy for programme managers and companies to see the fit quickly: what can be booked, how the process works, what the first step is and why the training is practical rather than theoretical decoration.",
            salesSignals: [
                {title: "Fast fit check", copy: "Visitors can compare topics, formats, pricing and contact options without hunting through a long portfolio page."},
                {title: "Professional proof", copy: "Teaching hours, rating, certificates, projects and client work are separated into focused proof pages instead of overwhelming the first screen."},
                {title: "Low-friction booking", copy: "Every key route leads to email, phone or calendar booking, so interested visitors can move from interest to a concrete call quickly."},
            ],
            ...
            myWayPreviewCopy: "A short professional timeline helps visitors understand the background behind the teaching profile: business informatics, software practice, adult education, entrepreneurship, Brisbane and international remote delivery.",
        ...
        contact: {
            ...
            briefCopy: "A short request is enough. These points make it easier to suggest the right format quickly.",
    ...
    de: {
        ...
        home: {
            ...
            salesSignalCopy: "Die Startseite soll Programmverantwortlichen und Unternehmen sofort zeigen, was buchbar ist, wie die Zusammenarbeit abläuft, welcher nächste Schritt sinnvoll ist und warum das Training praktisch statt nur abstrakt ist.",
            salesSignals: [
                {title: "Schneller Fit-Check", copy: "Besucher sehen Themen, Formate, Preise und Kontaktwege, ohne sich durch eine lange Portfolio-Seite arbeiten zu müssen."},
                {title: "Professioneller Nachweis", copy: "Unterrichtsstunden, Bewertung, Zertifikate, Projekte und Kundenarbeit liegen auf klaren Unterseiten statt alles auf der Startseite zu überladen."},
                {title: "Wenig Buchungsreibung", copy: "Die wichtigsten Wege führen direkt zu E-Mail, Telefon oder Kalenderbuchung, damit aus Interesse schnell ein konkretes Gespräch wird."},
            ],
            ...
            popularRoute: "Haeufig",
            bookingRoutes: [
                {title: "Dozentin fuer bestehenden Kurs", copy: "Fuer Kohorten, Zeitplaene und Module, die bereits stehen und verlaessliche Remote-Durchfuehrung brauchen.", bullets: ["Kursdurchfuehrung", "Erwachsenenbildung", "klare Materialien"], cta: "Kurs klaeren", to: "/contact#contact-options"},
                {title: "AI- oder IT-Training fuer ein Team", copy: "Fuer Teams, die praktische Kompetenz, sicherere Tool-Nutzung oder gemeinsame Sprache rund um AI, Daten, Security oder Software brauchen.", bullets: ["Team-Workshops", "Hands-on-Uebungen", "Business-Relevanz"], cta: "Workshop planen", to: "/training"},
                {title: "Vortrag, Keynote oder Expertenimpuls", copy: "Fuer Events, Lerntage und Leadership Briefings, die schnell Orientierung schaffen sollen.", bullets: ["90 Minuten bis Tagesformat", "AI, Governance, Security", "remote-first"], cta: "Preise ansehen", to: "/pricing"},
            ],
            ...
            myWayPreviewCopy: "Eine kurze professionelle Timeline zeigt den Hintergrund hinter dem Trainingsprofil: Wirtschaftsinformatik, Softwarepraxis, Erwachsenenbildung, Unternehmertum, Brisbane und internationale Remote-Durchfuehrung.",
            myWayHighlights: ["10k+ Unterrichtsstunden", "Business IT, AI und Cybersecurity", "Remote Delivery aus Brisbane"],
            faq: "FAQ",
        ...
        contact: {
            ...
            briefTitle: "Hilfreiche Angaben fuer eine schnelle Rueckmeldung",
            briefCopy: "Eine kurze Anfrage reicht. Diese Punkte helfen, schnell ein passendes Format vorzuschlagen.",
            briefItems: ["Thema oder Trainingsziel", "Zielgruppe und Wissensstand", "gewuenschter Zeitraum", "Format: Vortrag, Workshop oder Kurs", "Sprache: Deutsch oder Englisch"],
        },
        analytics: {
