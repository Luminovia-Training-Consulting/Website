...
const dictionaries = {
  en: {
    ...
    contact: {
      ...
      errorTitle: "The form could not send the message.",
      fallbackTitle: "Direct fallback",
      fallbackCopy: "Please use the direct email button or book a call if the form is unavailable.",
      calendarFallback: "Book a call",
      localUnavailable: "Local Vite preview cannot execute the PHP mail endpoint. The form must be tested on Hostinger or through a PHP server.",
      namePlaceholder: "Your name",
      emailPlaceholder: "you@example.com",
      phonePlaceholder: "+61 ... / +49 ...",
  ...
  de: {
    ...
    contact: {
      ...
      errorTitle: "Das Formular konnte die Nachricht nicht senden.",
      fallbackTitle: "Direkte Alternative",
      fallbackCopy: "Nutzen Sie bitte direkt die E-Mail-Schaltfläche oder buchen Sie einen Termin, falls das Formular nicht verfügbar ist.",
      calendarFallback: "Termin buchen",
      localUnavailable: "Die lokale Vite-Vorschau kann den PHP-Mail-Endpunkt nicht ausführen. Das Formular muss auf Hostinger oder über einen PHP-Server getestet werden.",
