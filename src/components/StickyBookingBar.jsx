...
export default function StickyBookingBar() {
    ...
    return (
        <aside className="pointer-events-none fixed inset-x-0 bottom-4 z-40 px-4 sm:bottom-5" aria-label={t.stickyBooking.label}>
            <div className="booking-bar pointer-events-auto mx-auto flex max-w-4xl flex-col gap-3 rounded-[1.6rem] border border-white/12 bg-[#071225]/88 p-3 shadow-[0_18px_74px_rgba(0,0,0,.38),0_0_38px_rgba(125,211,252,.08)] backdrop-blur-2xl sm:flex-row sm:items-center sm:justify-between">
