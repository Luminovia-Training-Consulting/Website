...
export default function Card({ children, className = "", shine = true }) {
  return (
    <div className={cn("rainbow-edge group relative overflow-hidden rounded-[2.15rem] border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,.12),rgba(255,255,255,.055)_50%,rgba(255,255,255,.035))] p-5 shadow-[0_26px_96px_rgba(0,0,0,.25)] backdrop-blur-2xl transition duration-700 ease-out hover:-translate-y-2 hover:rotate-[.18deg] hover:border-sky-200/45 hover:bg-white/[0.1] hover:shadow-[0_36px_140px_rgba(37,99,235,.2)] sm:p-6", className)}>
      ...
      <div className="pointer-events-none absolute -bottom-1 left-8 right-8 h-px bg-gradient-to-r from-transparent via-fuchsia-200/40 to-transparent opacity-0 transition duration-700 group-hover:opacity-100" />
