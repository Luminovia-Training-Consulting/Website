...
export default function Card({ children, className = "", shine = true, ...props }) {
  return (
    <div {...props} className={cn("rainbow-edge group relative flex h-fit min-h-0 flex-col justify-start overflow-hidden rounded-[1.8rem] border border-white/13 bg-[radial-gradient(circle_at_18%_0%,rgba(255,255,255,.17),transparent_38%),linear-gradient(145deg,rgba(255,255,255,.125),rgba(255,255,255,.062)_52%,rgba(255,255,255,.034))] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,.11),inset_0_-26px_56px_rgba(255,255,255,.022),0_22px_78px_rgba(0,0,0,.32)] backdrop-blur-2xl transition duration-700 ease-out hover:-translate-y-1.5 hover:rotate-[.12deg] hover:border-white/28 hover:bg-white/[0.105] hover:shadow-[inset_0_1px_0_rgba(255,255,255,.16),0_30px_110px_rgba(0,0,0,.34),0_0_46px_rgba(255,255,255,.045)] sm:p-5", className)}>
