...
export default function Card({children, className = "", shine = true, ...props}) {
    return (
        <div {...props}
            ...
            <div className="card-accent-pin pointer-events-none absolute right-5 top-5 h-2.5 w-10 rounded-full opacity-80 transition duration-700 group-hover:w-14"/>
            <div className="card-accent-orb-a pointer-events-none absolute -left-16 -top-20 h-44 w-44 rounded-full opacity-45 blur-3xl transition duration-700 group-hover:opacity-80"/>
            <div className="card-accent-orb-b pointer-events-none absolute right-[-4rem] top-1/4 h-36 w-36 rounded-full opacity-70 blur-3xl transition duration-700 group-hover:translate-y-4"/>
            <div className="card-accent-left pointer-events-none absolute inset-y-0 -left-1 w-px opacity-35 transition duration-700 group-hover:opacity-100"/>
