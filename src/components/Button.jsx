...
export default function Button({ href, to, children, variant = "primary", onClick }) {
  const base = "inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-full px-5 py-3 text-center text-sm font-black leading-tight transition duration-500 ease-out hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-teal-300/60 sm:w-auto";
  const styles = variant === "primary"
    ? "bg-gradient-to-r from-white via-teal-50 to-pink-50 text-zinc-950 shadow-[0_16px_44px_rgba(45,212,191,.22)] hover:shadow-[0_22px_80px_rgba(244,114,182,.22)]"
    : variant === "dark"
