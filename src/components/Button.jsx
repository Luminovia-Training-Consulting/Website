...
export default function Button({href, to, children, variant = "primary", onClick, download, showArrow = true}) {
    const base = "color-button inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-full px-5 py-3 text-center text-sm font-black leading-tight transition duration-500 ease-out hover:-translate-y-1.5 active:translate-y-0 focus:outline-none focus:ring-2 focus:ring-sky-300/70 sm:w-auto";
