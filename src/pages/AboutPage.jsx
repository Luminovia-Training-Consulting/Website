...
const copy = {
  en: {
    ...
    intro: "My main work is teaching, speaking and professional training. I combine business informatics, AI, cybersecurity, software development and didactics to help learners build real competence instead of just hearing buzzwords.",
  ...
  de: {
    ...
    intro: "Mein Schwerpunkt ist Lehre, Speaking und professionelle Weiterbildung. Ich verbinde Wirtschaftsinformatik, AI, Cybersecurity, Softwareentwicklung und Didaktik, damit Lernende echte Kompetenz aufbauen statt nur Buzzwords zu hören.",
    ...
    links: [
      ...
      ["Blog", "Notizen und zukünftige Beiträge zu AI, Lehre, Research, Softwareprojekten und persönlichen Updates.", "/blog"],
    ],
