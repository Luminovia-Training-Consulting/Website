...
const copy = {
    en: {
        ...
        intro: "Book Luminovia when your audience needs digital skills explained clearly, practised actively and connected to their work, from AI literacy to cybersecurity, programming and business IT.",
        process: [
        ...
        ctaTitle: "Need a reliable training or speaking partner?",
        ctaCopy: "Send the topic, audience, format and date range. Luminovia will suggest a suitable training setup.",
        cta: "Request availability",
    },
    de: {
        badge: "Für Organisationen",
        title: "Trainingslösungen für Unternehmen, Bildungsanbieter und Events.",
        intro: "Buchen Sie Luminovia, wenn Ihr Publikum digitale Themen klar erklärt, aktiv geübt und mit der eigenen Arbeit verbunden braucht, von AI Literacy über Cybersecurity bis Programmierung und Business-IT.",
        process: [
        ...
        ctaTitle: "Brauchen Sie einen verlässlichen Trainings- oder Speaking-Partner?",
        ctaCopy: "Senden Sie Thema, Zielgruppe, Format und Zeitraum. Luminovia schlägt ein passendes Trainingssetup vor.",
