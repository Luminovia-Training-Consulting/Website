...
const copy = {
    ...
    de: {
        ...
        intro: "Für Konferenzen, interne Lerntage, Bildungsprogramme und Leadership-Sessions, die Orientierung zu AI, Cybersecurity, digitaler Transformation oder Future Skills brauchen. Die Talks arbeiten mit Praxisbeispielen, Risikobewusstsein und konkreten nächsten Schritten für das Publikum.",
        request: "Speaker-Verfügbarkeit anfragen",
        proof: "Referenzen ansehen",
        topic: "Talk-Thema",
        talks: [
            ...
            ["Future Skills in Business IT", "Wie AI, Daten, Automatisierung und digitale Tools berufliche Kompetenz verändern."],
            ["Prompt Engineering für Professionals", "Wie man mit AI-Systemen strukturiert, hochwertig und wiederholbar kommuniziert."],
    ...
    return (
        <main className="px-4 pb-24 pt-32 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl">
                <Badge tone="orange">{c.badge}</Badge>
                <div className="mt-6 grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
                    ...
                    <Photo src={IMAGES.headshot} alt="Headshot of Carina Sophie Schoppe for IT keynote talks" className="aspect-[4/5] rounded-2xl" imgClass="object-[50%_18%]"/>
                </div>
