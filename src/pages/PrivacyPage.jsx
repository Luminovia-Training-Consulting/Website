...
const enSections = [
  ["Controller", "The controller responsible for this website is Carina Sophie Schoppe, Under the Hakenberge 5, 37619 Bodenwerder, Germany. You can contact me by email at info@carinaschoppe.com."],
  ...
  ["Contact and booking links", "If you contact me by email, form or an external booking link, the information you provide is processed to answer your request and organise the requested training, lecture, workshop or call."],
...
const deSections = [
  ["Verantwortliche Stelle", "Verantwortlich für diese Website ist Carina Sophie Schoppe, Under the Hakenberge 5, 37619 Bodenwerder, Germany. Kontakt ist per E-Mail unter info@carinaschoppe.com möglich."],
  ...
  ["Kontakt und Buchungslinks", "Wenn Sie mich per E-Mail, Formular oder externem Buchungslink kontaktieren, werden die angegebenen Daten verarbeitet, um Ihre Anfrage zu beantworten und Training, Vortrag, Workshop oder Call zu organisieren."],
