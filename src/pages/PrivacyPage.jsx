...
const enSections = [
    ...
    ["Contact and booking links", "If you contact me by email, form, phone or an external booking link, the information you provide is processed to answer your request and organise the requested training, lecture, workshop or call."],
...
const deSections = [
    ["Verantwortliche Stelle", `Verantwortlich fuer diese Website ist ${controllerAddress}. Kontakt ist per E-Mail unter ${PROFILE.email}, telefonisch in Australien unter ${PROFILE.phoneAustralia} oder telefonisch in Deutschland unter ${PROFILE.phoneGermany} moeglich.`],
    ["Zugriffsdaten und Hosting", "Der Hosting-Anbieter kann technische Zugriffsdaten wie IP-Adresse, Zeitpunkt, abgerufene Dateien, Browsertyp, Betriebssystem und Referrer verarbeiten, um die Website bereitzustellen und zu schuetzen."],
    ["Kontakt und Buchungslinks", "Wenn Sie mich per E-Mail, Formular, Telefon oder externem Buchungslink kontaktieren, werden die angegebenen Daten verarbeitet, um Ihre Anfrage zu beantworten und Training, Vortrag, Workshop oder Call zu organisieren."],
    ...
    ["Ihre Rechte", "Je nach anwendbarem Datenschutzrecht koennen Rechte auf Auskunft, Berichtigung, Loeschung, Einschraenkung, Datenuebertragbarkeit, Widerspruch und Widerruf einer Einwilligung bestehen."],
];
    ...
    return (
        <main className="px-4 pb-24 pt-32 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-4xl">
                ...
                <h1 className="mt-6 text-5xl font-black tracking-[-0.05em] text-white sm:text-6xl">{isDe ? "Datenschutzerklaerung" : "Privacy Policy"}</h1>
                <p className="mt-5 text-lg leading-8 text-slate-300">
                    {isDe ? "Diese Erklaerung beschreibt, welche Daten bei der Nutzung dieser Website verarbeitet werden koennen." : "This policy explains what data may be processed when using this website and how analytics works."}
                </p>
