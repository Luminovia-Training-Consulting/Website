...
const deHomeContent = {
    ...
    faqs: [
        ...
        {q: "Wie funktioniert Remote Delivery aus Brisbane?", a: "Remote-Durchführung wird nach Zielgruppe und Zeitzone geplant. Ich positioniere Live-Online-Trainings für deutschsprachige und internationale Kunden in Europa, Australien und APAC."},
        {q: "Was macht deine Trainings praktisch?", a: "Sessions sind auf klare Outcomes, Beispiele, Übungen, Recaps, Lernaktivierung und Transferaufgaben ausgerichtet. Ziel ist nicht nur Tool-Erklärung, sondern nutzbare Anwendung in Arbeit oder Studium."},
