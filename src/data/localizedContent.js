...
const de = {
    trustStats: [
        ...
        {value: "Workshops bis Programme", label: "Formate von Kurzbriefings bis zu mehrstufigen Lernpfaden"},
    ],
    coreOffers: [
        {
            ...enCoreOffers[0],
        ...
        deliverables: ["KI-Kompetenz und verantwortungsvolle Nutzung", "Prompt Engineering für Büro- und Fachanwendungen", "Praxisübungen für reale Geschäftsszenarien", "Vorlagen für Arbeitsabläufe und Checklisten", "Optionales Briefing für Führungskräfte"],
            bestFor: "Unternehmen, öffentliche Teams, Bildungsanbieter, KMU",
        },
        {
            ...enCoreOffers[1],
        kicker: "Trainingsdurchführung",
        ...
        deliverables: ["Python, SQL, Datenbanken, KI, Cloud und Cybersecurity", "Theorieblöcke kombiniert mit angeleiteten Übungen", "Lernchecks, Zusammenfassungen und Transferaufgaben", "Vorbereitete Materialien, Praxislabore und Lernpfade", "Deutsch oder Englisch für unterschiedliche Wissensstände"],
    ...
    formats: [
        ...
        {title: "2-5 Tage Intensivtraining", label: "Kompetenzaufbau", copy: "Für vertieften Kompetenzaufbau in KI, Python, SQL, Cybersecurity, Cloud-Grundlagen, Wirtschaftsinformatik oder digitaler Transformation."},
        ...
        {title: "Curriculum- und Materialentwicklung", label: "Lerndesign", copy: "Konzeption von Kursplänen, Übungen, Lernchecks, Präsentationen, Praxislaboren und verständlicher Dokumentation."},
    ...
    trainingTopics: [
        {group: "KI und Zukunftskompetenzen", items: ["KI-Kompetenz", "Prompt Engineering", "Arbeitsabläufe mit generativer KI", "Verantwortungsvolle KI", "Grundlagen der KI-Governance", "KI für Büroproduktivität"]},
    ...
    serviceOfferings: [
        ...
        {title: "KI-Governance und verantwortungsvolle KI", description: "Training zu Verantwortlichkeit, Risikoklassen, Datenhandhabung, menschlicher Aufsicht und praktischen Governance-Routinen.", audience: "Führungskräfte, Programmverantwortliche, Compliance-nahe Teams und Bildungseinrichtungen", format: "Führungskräfte-Briefing, Workshop oder Governance-Training", duration: "90 Minuten bis 2 Tage", outcomes: ["KI-Risiken klarer bewerten", "Governance-Verantwortung definieren", "praktische Prüfroutinen aufbauen"]},
        ...
        {title: "Scrum, agile Methoden und digitale Projektarbeit", description: "Praktisches Projektarbeitstraining für klarere Zusammenarbeit, verlässliche Abläufe und einen bewussten Einsatz von KI.", audience: "Projektteams, Auszubildende, KMU, Bildungsanbieter und digitale Teams", format: "Workshop, Trainingstag oder angewandtes Projektlabor", duration: "Halbtags bis 2 Tage", outcomes: ["agile Begriffe korrekt nutzen", "Arbeit sichtbar strukturieren", "Kommunikation und Prüfprozesse verbessern"]},
        ...
        {
        title: "Curriculum-Entwicklung und Blended Learning",
    ...
    timeline: deTimeline,
    faqs: [
        {q: "Wofür kann man Luminovia buchen?", a: "Luminovia bietet IT- und Prozessberatung, Trainingsprogramme, KI-Governance, Cybersecurity Awareness, Software- und Datentraining, digitale Transformation und Curriculum-Entwicklung. Typische Formate sind Beratungssprints, Workshops, Remote-Live-Kurse, Fachvorträge, Kompetenzprogramme und Projektbegleitung."},
        ...
        {q: "Gibt es ganze Kurse oder nur kurze Workshops?", a: "Beides. Möglich sind 90-minütige Fachimpulse, Halbtagesworkshops, Trainingstage, Beratungssprints, mehrtägige Intensivtrainings, mehrwöchige Kurse und größere Programme für Bildungsanbieter oder Organisationen."},
        {q: "Welche KI-Themen werden besonders häufig angefragt?", a: "Häufige Themen sind KI-Kompetenz, generative KI für Teams, Prompt Engineering, agentische Arbeitsabläufe, verantwortungsvolle KI, KI-Governance, Automatisierungsrisiken und die praktische Einführung von KI in Unternehmen oder Bildungskontexten."},
        ...
        {q: "Was macht die Trainings praktisch?", a: "Jeder Termin verbindet klare Lernziele, Beispiele, Übungen, Zusammenfassungen und Transferaufgaben. Teilnehmende lernen Werkzeuge nicht nur kennen, sondern wenden sie auf Situationen aus Arbeit, Studium oder Lehrpraxis an."},
        {q: "Kann Luminovia Materialien oder ein Curriculum entwickeln?", a: "Ja. Luminovia entwickelt Curricula, Blended-Learning-Konzepte, Präsentationen, Übungen, Lernchecks, Praxislabore, Beratungsdokumentation, KI-Anwendungsfallkarten, Umsetzungsfahrpläne und Trainingsstrukturen für Akademien, Hochschulen und betriebliche Weiterbildungsteams."},
